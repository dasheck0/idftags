...
describe IDFTags::BadWordLexicon do

  before :each do
    @bad_word_lexicon = IDFTags::BadWordLexicon.new :de
  end

  describe '#initialize' do
    it 'should set the locale' do
      bad_word_lexicon = IDFTags::BadWordLexicon.new :en
      expect(bad_word_lexicon.instance_variable_get(:@locale)).to eq(:en)
    end

    it 'should set the bad words' do
      bad_word_lexicon = IDFTags::BadWordLexicon.new :en, ['test']
